...
${OBJECTDIR}/src/BasicWaveform.o: src/BasicWaveform.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/BasicWaveform.o src/BasicWaveform.cpp

${OBJECTDIR}/src/Envelope.o: src/Envelope.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Envelope.o src/Envelope.cpp

${OBJECTDIR}/src/Handle.o: src/Handle.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Handle.o src/Handle.cpp

${OBJECTDIR}/src/Noise.o: src/Noise.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Noise.o src/Noise.cpp

${OBJECTDIR}/src/Panpot.o: src/Panpot.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Panpot.o src/Panpot.cpp
...
${OBJECTDIR}/src/StepWaveform.o: src/StepWaveform.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/StepWaveform.o src/StepWaveform.cpp

${OBJECTDIR}/src/enum_map.o: src/enum_map.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/enum_map.o src/enum_map.cpp
