...
${OBJECTDIR}/src/BasicWaveform.o: src/BasicWaveform.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/BasicWaveform.o src/BasicWaveform.cpp
...
${OBJECTDIR}/src/Random.o: src/Random.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Random.o src/Random.cpp
