...
${OBJECTDIR}/src/BasicWaveform.o: src/BasicWaveform.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/BasicWaveform.o src/BasicWaveform.cpp
...
${OBJECTDIR}/src/Noise.o: src/Noise.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Noise.o src/Noise.cpp
...
${OBJECTDIR}/src/StepWaveform.o: src/StepWaveform.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/StepWaveform.o src/StepWaveform.cpp

${OBJECTDIR}/src/enum_map.o: src/enum_map.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/enum_map.o src/enum_map.cpp
